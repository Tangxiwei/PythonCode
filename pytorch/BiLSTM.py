...
model = BiLSTMModel(input_size=input_size, hidden_size=64, output_size=output_size, num_layers=2, dropout_prob=0.5).to(
    device)
...
torch.save(model.state_dict(), 'model_weights_0545_BiLSTM.pth')
...
plt.plot(y_pred_inv, label='Predicted Data (BiLSTM)', color='red')
